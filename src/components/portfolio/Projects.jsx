...
const projects = [
  ...
  {
    id: '02',
    title: 'Community Automation Platform',
    category: 'Automation System',
    description:
      'Full-stack automation system featuring intelligent moderation, automated workflows, ticket management, advanced logging, and comprehensive admin dashboards for scaling community operations.',
  ...
  },
  {
    ...
    description:
      'Full-stack admin dashboard with real-time data visualization, system configuration, analytics, user management, and dynamic content control. Built for scalability and intuitive administration.',
  ...
  {
    id: '04',
    title: 'Intelligent Automation Assistant',
    category: 'AI Integration',
    description:
      'AI-powered automation system with advanced natural language processing, contextual responses, and intelligent workflow automation. Demonstrates integration of external AI services with custom backend logic.',
